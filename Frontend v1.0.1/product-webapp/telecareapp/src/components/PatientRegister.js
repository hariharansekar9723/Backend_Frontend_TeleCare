...
export default class PatientRegister extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    axios.post('http://localhost:8080/api/v1/patient', {
      // id: 94,
      patientEmailId: this.state.doctorEmailId,
      password: this.state.password,
      patientName: "",
      contactNo: "",
      dob: "",
                ...
                <div class="card" style={{ borderRadius: "1rem", height:'680px'}}>
                  <div class="row g-0">
                    <div class="col-md-6 col-lg-5 d-none d-md-block">
                      <img src={logo}
                        alt="login form" class="img-fluid" style={{ borderRradius: "1rem 0 0 1rem", width: '500 px', height: '590px', backgroundColor: '#936c6c' }} />
                    </div>
                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <form>
                          ...
                          <h5 class="fw-normal mb-3 pb-3" style={{ letterSpacing: "1px", marginLeft: '90px', color:'#89CFF0'}}>Patient Register Page</h5>
                          ...
                          <div class="form-outline mb-4">
                            <input type="password" id="form2Example27" class="form-control form-control-lg" onChange={this.handleConfirmPassword} isInvalid={!!this.state.passwordConfirmErr} />
                            <div style={{ color: 'red' }}>{this.state.passwordConfirmErr}</div>
                            <div style={{ color: 'red' }}>{this.state.passwordMismatch}</div>
                          </div>
