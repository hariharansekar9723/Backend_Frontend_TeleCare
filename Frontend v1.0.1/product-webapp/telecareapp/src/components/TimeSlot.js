      ...
      <div className="divBox">
        <Modal.Dialog className="main">
          ...
          <Modal.Body className="main">            
            <Card.Text style={{ textAlign: 'left' }}>Appointment Date: <input className="slotDate" type="date" placeholder='Select date' value={this.state.inputValue1} onChange={evt => this.updateInputValue1(evt)} /></Card.Text>
            <Card.Text style={{ textAlign: 'left' }}> <span className="padingStartT">Start Time :</span> <input className="slotTime"  type="time" value={this.state.inputValue2} onChange={evt => this.updateInputValue2(evt)} />
            <span className="padingStartT padingEndT">End Time :</span><input className="slotTime" type="time" value={this.state.inputValue3} onChange={evt => this.updateInputValue3(evt)} /></Card.Text>
